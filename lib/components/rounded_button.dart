...
class RoundedButton extends StatelessWidget {
  final String label;
  final RoundedButtonColor color;
        ...
        child: Container(
          ...
          child: Align(
            ...
            child: Text(
              label,
              style: TextStyle(
                color: color != RoundedButtonColor.light
                    ? Colors.white
                    : Colors.black,
